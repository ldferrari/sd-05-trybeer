...
const detailOrder = (saleId) => connection.query('SELECT sale_id, product_id, quantity, name, price, url_image FROM Trybeer.sales_products inner JOIN products ON sales_products.product_id = id WHERE sale_id = ?;', [saleId])
